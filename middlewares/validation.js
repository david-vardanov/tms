...
const carrierSetupSchema = Joi.object({
  ...
  coi: Joi.object().unknown().required(),
  MCAuthority: Joi.object().unknown().required(),
  w9: Joi.object().unknown().required(),
  noa: Joi.object().unknown().optional(),
  voidCheck: Joi.object().unknown().optional(),
